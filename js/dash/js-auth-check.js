...
async function getDiagnosesQueries() {
  ...
  const diag_query_url =
    "https://farm-aid-backend.herokuapp.com/api/nvir/diagnosis";
          ...
          .then(() => {
            ...
            diagnosis_res.then((vals) => {
              ...
              <div class="table-body-cell">
                ...
                ` +
                  `Animal <b>` +
                  dg_query.animal.charAt(0).toUpperCase() +
                  dg_query.animal.slice(1) +
                  `</b> <br>Disease<b> ` +
                  dg_query.diseasesFound[0] +
                  `
                </b></div>
                <div class="table-body-cell">
                 <p class="control">
          ...
          <div class="flex-card team-card light-bordered light-raised">
              ...
              <div class="card-body">
                ...
                `">
                  ...
                  <div class="user-id">
                      <div class="name"><i class="sl sl-icon-envelope-open"></i> ` +
                nvri_user.email +
                `</div>
                      <div class="position"> ` +
                nvri_user.role +
                ...
                `
                  ...
                  <div class="card-action has-text-centered">
                      ...
                      <button data-id="` +
                nvri_user.email +
                `" class="button btn-dash rounded secondary-btn is-6 ripple no-lh remove_user">Delete</button>
                  </div>
              </div>
          </div>
        </div>`;
            ...
            $("#reg_users_para").append(
              `${resp.length - cahw_count - 1} Paravet(s)`
            );
